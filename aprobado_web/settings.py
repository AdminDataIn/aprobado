...
DATACREDITO_DECISOR_TOKEN_USERNAME = os.environ.get('DATACREDITO_DECISOR_TOKEN_USERNAME', '')
DATACREDITO_DECISOR_TOKEN_PASSWORD = os.environ.get('DATACREDITO_DECISOR_TOKEN_PASSWORD', '')
...
DATACREDITO_HDC_TOKEN_USERNAME = os.environ.get('DATACREDITO_HDC_TOKEN_USERNAME', '')
DATACREDITO_HDC_TOKEN_PASSWORD = os.environ.get('DATACREDITO_HDC_TOKEN_PASSWORD', '')
...
DATACREDITO_HDC_PARAMETERS_JSON = os.environ.get('DATACREDITO_HDC_PARAMETERS_JSON', '')
