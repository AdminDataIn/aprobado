...
class SesionCapturaDocumental(models.Model):
    ...
    capture_grant_hash = models.CharField(max_length=64, blank=True, editable=False)
    capture_grant_expira_en = models.DateTimeField(null=True, blank=True, editable=False)
    capture_grant_revocado_en = models.DateTimeField(null=True, blank=True, editable=False)
